...
export const BOOKING_COPY = {
  ...
  senior: {
    ...
    subtitleZh:
      '您只需提供姓名、性别、电话号码、出生年月日和方便时间即可，我们帮您登记',
    subtitleEn:
...
export const ABOUT_COPY = {
  ...
  paragraphs: [
    '**福和堂（HOCK HOE TONG）**创立于1987年，作为老字号药材店，我们传承近四十年的中医智慧与经验。如今，**【福和堂】**已正式从拉美士（Labis）迁至**新山（JB）**，并由单一药材零售扩展为**【药材店兼中医馆】**，为大众健康提供更全面的服务。',
    '作为正统药材店，我们专营多种**优质中草药：**人参、泡参、西洋参、党参、冬虫草、洞燕、枸杞、红枣、麦冬等。除此之外，还提供多款**传统凉茶**与药包冲剂，如杂凉茶、何人可茶、白花蛇舌草水、夏桑菊花茶、罗汉果菊花茶、湿热茶等。更有天然**野山蜜糖、自酿黄酒、**正品灵芝酒、巴戟酒、杜仲补药精、虫草泡参精、银杏泡参精、五加皮酒等**养生佳品，**品类齐全，品质保证。',
    '本医馆的驻诊医师**硕士**毕业于**上海中医药大学，**本科亦为该校**优秀毕业生**，系统研修岐黄之道，兼具扎实的理论基础与丰富的临床经验。师从多位名中医，并在龙华医院、曙光医院、光华医院及岳阳中西医结合医院等**上海市三甲医院轮转学习。**目前，该医师已**合法注册马来西亚中医师执业执照，**获准在当地开展临床服务。',
    '医师秉持“承岐黄之道 • 济苍生之需”的理念，擅长运用传统中草药、针灸、推拿及养生调理，为患者提供个性化的健康方案。多年来致力于弘扬中医文化，结合现代医学理念，帮助大众改善体质、调理身心，提升整体健康水平。',
  ],
  address: {
    labelZh: '医馆地址',
    labelEn: 'Address',
